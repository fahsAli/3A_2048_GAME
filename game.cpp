...
std::string display_number(int num){
    ...
    return "\033[1;"+color+";49m"+ str +"\033[0m";
    //return str;
}
...
void game::Game::display(){
    ...
    for(int i=0;i<_grille_size;i++){
        //std::cout << "--------";
        std::cout << "\033[1;39;49m--------\033[0m";
    }
    std::cout << "-" << std::endl;
    for(int i=0;i<_grille.capacity();i++){
        //std::cout << "| " << ((_grille.at(i)>1)?display_number(_grille.at(i)):"      ");
        std::cout << "\033[1;39;49m| \033[0m" << ((_grille.at(i)>1)?display_number(_grille.at(i)):"      ");
        if(i%_grille_size == (_grille_size-1)){
            //std::cout << "|" << std::endl;
            std::cout << "\033[1;39;49m|\033[0m" << std::endl;
            for(int j=0;j<_grille_size;j++){
                //std::cout << "--------";
                std::cout << "\033[1;39;49m--------\033[0m";
            }
            //std::cout << "-" << std::endl;
...
bool game::Game::can_move(){
    ...
    for(int i=0;i<_grille.capacity();i++){
        if(_grille.at(i)==2048){
            std::cout << "\n ---------------- \033[1;93;49mvictory\033[0m  ----------------" << std::endl;
            return false;
        }
    }
    ...
    std::cout << "\n ---------------- \033[1;31;49mlost\033[0m ----------------" << std::endl;
    return false;
}
...
void _2048(){
    ...
    std::cout << "  #           #      #           #    #      #" << std::endl;
    std::cout << "  ########    ########           #    ########" << std::endl;
    std::cout << ">>>>>>>>>>>>>>>>>> by \033[1;30;107mAli Fahs\033[0m <<<<<<<<<<<<<<<<<" << std::endl;
}
...
void game::Game::play(){
    ...
    do{
        ...
        case 'q': case 'Q':
            ...
            break;
        default:
            std::cout << "\033[1;31;49m>> undefined key try again ...\033[0m"<<std::endl;
            break;
        }
